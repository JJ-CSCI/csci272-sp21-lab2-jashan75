...
private :
int Latitude { Compass::N,S};
int Longitude {Compass :: E,W};
double LatitudeDirection {Compass :: N,S};
double Longitudedirection {Compass :: E, W}; 
...
class GPS {
  private:
 double getLatitude {90.0};
 double getLongitude {180.0};
 double LatitudeDirection {Compass :: N,S};
 double LongitudeDirection {Compass :: W,E};
 double getLatitude {return Latitude angle};
 double getLatitudeDirection {return LatitudeDirections};
 double getLongitude {return Longitude angle};
 double getLatitude { return LongitudeDirections};
